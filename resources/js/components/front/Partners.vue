  ...
  <section class="py-16" :class="props.bgColor">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative">
        ...
        <button
          @click="prevSlide"
          class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-3 p-2 rounded-full bg-white shadow-md border border-primary/30 text-primary hover:bg-primary/5 disabled:opacity-30 disabled:cursor-not-allowed z-10"
        ...
        <button
          @click="nextSlide"
          class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-3 p-2 rounded-full bg-white shadow-md border border-primary/30 text-primary hover:bg-primary/5 disabled:opacity-30 disabled:cursor-not-allowed z-10"
        ...
        <div class="flex justify-center gap-2 mt-8">
          <button
            ...
            :class="isActiveDot(n-1) ? 'bg-primary' : 'bg-gray-300 hover:bg-primary/50'"
          ></button>
        </div>
      </div>
    </div>
