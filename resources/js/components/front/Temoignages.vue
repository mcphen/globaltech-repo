        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div v-else class="relative">
                            ...
                            <div class="bg-gray-50 rounded-xl p-8 shadow-sm h-full">
                                <div class="flex items-center mb-6">
                                    <div class="flex-shrink-0">
                                        ...
                                        <div v-else class="h-12 w-12 rounded-full bg-primary/20 flex items-center justify-center">
                                <span class="text-primary font-semibold">{{ getInitials(testimonial.author_name) }}</span>
                            </div>
                                    </div>
                                    <div class="ml-4">
                ...
                <div class="flex justify-center mt-8 gap-3">
                    <button
                        @click="prevSlide"
                        class="p-2 rounded-full border border-primary/30 text-primary hover:bg-primary/5 disabled:opacity-30 disabled:cursor-not-allowed"
