...
// Props (catégories depuis le serveur)
const props = defineProps<{ categories?: Record<string, string> }>();
const categoryOptions = computed(() => {
    if (props.categories) {
        return Object.entries(props.categories).map(([value, label]) => ({ value, label }));
    }
    return [
