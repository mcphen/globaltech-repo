                ...
                <div v-for="service in servicesList" :key="service.id" class="bg-white border rounded-xl shadow-sm hover:shadow-md transition overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex-1 flex flex-col">
                        <div class="flex items-center mb-2">
                            <span v-if="service.icon" class="text-2xl mr-2">{{ service.icon }}</span>
                            <h3 class="text-lg font-semibold text-gray-800">{{ service.title }}</h3>
                        </div>
                        <p v-if="service.subtitle" class="text-gray-700 text-sm mb-2">{{ service.subtitle }}</p>
                ...
                <table class="min-w-full bg-white divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sous-titre</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="service in servicesList" :key="service.id" class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div v-if="service.icon" class="text-2xl">{{ service.icon }}</div>
                                <span v-else class="text-sm text-gray-400 italic">Non défini</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ service.title }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div v-if="service.subtitle" class="text-sm text-gray-700">{{ service.subtitle }}</div>
                                <span v-else class="text-sm text-gray-400 italic">Non défini</span>
                            </td>
                            <td class="px-6 py-4">
