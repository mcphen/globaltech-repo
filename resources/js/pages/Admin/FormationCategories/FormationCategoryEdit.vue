...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: 'Modifier', href: route('admin.formation-categories.edit', props.category.id) },
];
...
const form = useForm({
    ...
    color: props.category.color ?? '#2563EB',
    background: props.category.background ?? '#EFF6FF',
...
function submit() {
    ...
    form.put(route('admin.formation-categories.update', props.category.id), {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-white shadow-sm">
            <div class="border-b pb-6">
                ...
                <p class="text-gray-500 mt-1">{{ props.category.name }}</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center gap-2">
                            <input id="background" v-model="form.background" type="color"
                                class="h-10 w-16 rounded-md border-gray-300 cursor-pointer" />
                            <input v-model="form.background" type="text"
                                class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 font-mono text-sm" />
                        </div>
